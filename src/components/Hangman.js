      ...
      <g id="Page-1" fill="none" fillRule="evenodd">
        <g id="hangman-purple" transform="translate(12 12)">
          <g id="blood" transform="translate(365 460)">
            <path id="Path" fill="#BE1631" d="M22.826 26.26c-1.095-2.844-7.053-3.03-13.31-.412C3.263 28.466-.92 32.895.175 35.739c1.095 2.846 7.053 3.03 13.308.412 6.256-2.617 10.439-7.046 9.344-9.89z" />
          ...
          <g id="diagram" stroke="#220F22">
            ...
            <path id="rope" strokeLinecap="round" strokeWidth="20" d="M421 1v114" />
          </g>
