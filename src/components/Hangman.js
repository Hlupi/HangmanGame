...
const Hangman = props => {
  return (
    <svg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 496 574' role='img' width='400px'>
        ...
        <g id='hangman' transform='translate(12 12)'>
          <g id='blood' transform='translate(365 460)'>
            <path
              id='Path'
              fill='#BE1631'
              d='M22.826 26.099c-1.095-2.641-7.053-2.813-13.309-.383C3.262 28.147-.92 32.26.174 34.901c1.095 2.642 7.053 2.813 13.308.382 6.256-2.43 10.439-6.542 9.344-9.184z'
            />
            <path
              id='Path'
              fill='#9D1228'
